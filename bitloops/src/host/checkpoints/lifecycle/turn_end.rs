...
pub fn handle_lifecycle_turn_end_for_repo(
    ...
    handle_lifecycle_turn_end_for_repo_with_workspace_snapshot(repo_root, agent, event, None)
}

pub(crate) fn handle_lifecycle_turn_end_for_repo_with_workspace_snapshot(
    repo_root: &Path,
    agent: &dyn LifecycleAgentAdapter,
    event: &LifecycleEvent,
