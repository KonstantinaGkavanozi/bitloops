...
>
> This is the README of the upstream [Bitloops](https://github.com/bitloops/bitloops)
> project, kept because this repository is a fork of it. Everything below —
> install commands, links, badges, community channels — refers to upstream and
> **not** to this fork. The badges and download counts point at
> `bitloops/bitloops`, and the install commands install the official `bitloops`
> binary, not `cycloops`.
>
> For this fork, see [README.md](README.md).
